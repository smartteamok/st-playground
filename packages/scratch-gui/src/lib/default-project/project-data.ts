    ...
    return ({
        targets: [
            ...
            },
            {
                ...
                costumes: [
                    {
                        assetId: '5d58f2856d329173f2c5d7c9e32db251',
                        name: translator(messages.costume, {index: 1}),
                        bitmapResolution: 1,
                        md5ext: '5d58f2856d329173f2c5d7c9e32db251.svg',
                        dataFormat: 'svg',
                        rotationCenterX: 48,
                        rotationCenterY: 50
                    },
                    {
                        assetId: '8c49f40c11d5bdc6f0be60414b11736f',
                        name: translator(messages.costume, {index: 2}),
                        bitmapResolution: 1,
                        md5ext: '8c49f40c11d5bdc6f0be60414b11736f.svg',
                        dataFormat: 'svg',
                        rotationCenterX: 48,
                        rotationCenterY: 50
                    }
                ...
                sounds: [
                    {
                        assetId: '56a2b1d3f2298783e8b57fe173accdab',
                        name: translator(messages.meow),
                        dataFormat: 'wav',
                        format: '',
                        rate: 22050,
                        sampleCount: 6174,
                        md5ext: '56a2b1d3f2298783e8b57fe173accdab.wav'
                    }
                ],
                volume: 100,
                visible: true,
